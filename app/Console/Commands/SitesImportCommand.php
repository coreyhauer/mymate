...
class SitesImportCommand extends Command
{
    ...
    protected $description = 'Import sites from CSV, and optionally assign devices to them.';

    public function handle(ImportSites $importSites, AssignDevicesToSites $assign): int
    {
