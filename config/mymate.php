...
return [
    ...
    'map' => [
        ...
        // Optional weather-radar overlay (a toggle on the geo map). radar_url is a
        // RainViewer-style weather-maps.json the browser reads to find the latest radar
        // frame; csp_hosts are the hosts (tiles + api) added to the CSP so the browser may
        // load them. Empty radar_url = no weather layer at all. RainViewer is free and
        // keyless; point both at your own tiler if you prefer.
        'weather' => [
