...
export function GeoSearch({
    ...
    const hits = useMemo<GeoHit[]>(() => {
        ...
        // A prefix match is almost always the one you meant ("north" -> North Tower, not
        // "South-North backhaul"), so rank those above mid-string matches and let sites win ties.
